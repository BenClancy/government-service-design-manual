...
| a single point of user engagement, guided by user needs | fixed in time, but designed to evolve to meet changing needs |
...
* new user services must take the opportunity to reduce dependency on legacy systems, and new programmes should where possible avoid uneconomic expenditure on integrating with such systems
